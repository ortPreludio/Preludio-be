...
export const searchEventsByRole = asyncHandler(async (req, res) => {
  // Default sort for events is "fecha" asc, unlike the default "createdAt" desc
...
export const getEventByRole = asyncHandler(async (req, res) => {
